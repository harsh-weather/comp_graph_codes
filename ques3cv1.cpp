...
/// For better visualisation of polylines, we have drawn the function F(x,y) = (2*y,2*x).
/// The polylines have been made from two initial points, (30,20) and (-30,-20),
/// and they have been drawn till 5 iterations.
void display() {
